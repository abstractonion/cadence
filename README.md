...
37 durable rules, plus 12 command shims (`cadence-*` skills generated from `commands/`), organized into five groups:

| Group        | Purpose                                                                  | Count |
|--------------|--------------------------------------------------------------------------|------:|
| Workflow     | Engineering loop, learnings capture, and promotion (mostly always-on)  | 16    |
...
│   └── ... (37 rules + 12 cadence-* command shims from sync.sh)
