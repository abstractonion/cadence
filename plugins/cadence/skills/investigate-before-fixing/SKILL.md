...
description: Use when a bug, failing test, or unexpected behavior appears — trace the root cause before patching the symptom; cap hypothesis attempts at three before surfacing.
---
...
Recurring bugs in the same files are an architectural smell, not a coincidence. Say so when you see it.
